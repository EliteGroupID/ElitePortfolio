  ...
  return (
    <div className="min-h-screen bg-neutral-900 text-white font-popin">
      ...
      <div className="bg-neutral-900/80 backdrop-blur-md border-b border-neutral-700 px-6 py-4 flex items-center gap-3">
        ...
        <span className="text-neutral-400 text-sm">Products</span>
      </div>

      <main className="max-w-6xl mx-auto px-6 py-20">
        <div className="text-center mb-14">
          <p className="text-neutral-400 text-sm tracking-widest uppercase mb-2">What We Build</p>
        ...
        <div className="grid sm:grid-cols-2 gap-8">
          {productsList.map((product) => (
            <div
              key={product.slug}
              className="bg-neutral-800 rounded-xl overflow-hidden hover:-translate-y-1 transition-transform duration-200 shadow-lg"
            >
              ...
              <div className="p-6">
                ...
                <p className="text-neutral-400 text-sm mb-4">{product.shortDesc}</p>
        ...
        <div className="text-center mt-16">
          <Link
            href="/#contact"
            className="inline-block border border-neutral-400 text-neutral-300 hover:border-white hover:text-white px-8 py-3 rounded transition-colors duration-200"
          >
